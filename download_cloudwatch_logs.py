...
def main():
    ...
    parser.add_argument("--start_date", required=True, help="取得開始日時を YYYY-MM-DDTHH:MM:SS 形式で指定します。")
    parser.add_argument("--end_date", required=True, help="取得終了日時を YYYY-MM-DDTHH:MM:SS 形式で指定します。")
    parser.add_argument("--output_file", default="output.csv", help="保存するCSVファイルの名前を指定します。")
